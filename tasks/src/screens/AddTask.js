...
import { Modal, View, Text, TextInput, DatePickerIOS, StyleSheet, TouchableWithoutFeedback, TouchableOpacity, Alert, Platform, DatePickerAndroid } from 'react-native'
...
export default class AddTask extends Component {
    ...
    save = () => {
        if (!this.state.desc.trim()) {
            Alert.alert('Dados inválidos!', 'Informe uma descrição para a tafera.')
            return
        }
