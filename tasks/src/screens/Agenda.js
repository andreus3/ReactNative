...
export default class Agenda extends Component {
    state = {
        tasks: [
            { id: Math.random(), desc: 'Comprar curso React Native', estimateAt: new Date(), doneAt: new Date() },
            { id: Math.random(), desc: 'Concluir o curso React Native', estimateAt: new Date(), doneAt: null },
            { id: Math.random(), desc: 'Comprar curso React Native', estimateAt: new Date(), doneAt: new Date() },
            { id: Math.random(), desc: 'Concluir o curso React Native', estimateAt: new Date(), doneAt: null },
            { id: Math.random(), desc: 'Comprar curso React Native', estimateAt: new Date(), doneAt: new Date() },
            { id: Math.random(), desc: 'Concluir o curso React Native', estimateAt: new Date(), doneAt: null },
